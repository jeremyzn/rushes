...
import SpotifyRaw from "~icons/simple-icons/spotify";
import CircleSlashRaw from "~icons/lucide/circle-slash";
import ChromeRaw from "~icons/simple-icons/googlechrome";
import FirefoxRaw from "~icons/simple-icons/firefoxbrowser";
import SafariRaw from "~icons/simple-icons/safari";
import EdgeRaw from "~icons/simple-icons/microsoftedge";
...
export const Chrome = brand(ChromeRaw, "Chrome");
export const Firefox = brand(FirefoxRaw, "Firefox");
export const Safari = brand(SafariRaw, "Safari");
export const Edge = brand(EdgeRaw, "Edge");
export const CircleSlash = icon(CircleSlashRaw, "CircleSlash");
export const Spotify = brand(SpotifyRaw, "Spotify");
